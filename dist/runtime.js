...
exports.appendBracket = appendBracket;
exports.BASE_PATH = "https://api.earnfemi.com".replace(/\/+$/, "");
class Configuration {
    configuration;
 ...
 */
function appendBracket(formParams, baseName, value) {
    const walk = (prefix, val) => {
        if (val === null || val === undefined)
            return;
        if (val instanceof Blob || val instanceof File) {
            formParams.append(prefix, val);
            return;
        }
