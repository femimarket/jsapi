...
export function GooglePayFromJSON(json) {
    return GooglePayFromJSONTyped(json, false);
}
export function GooglePayFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function GooglePayToJSON(json) {
    return GooglePayToJSONTyped(json, false);
}
export function GooglePayToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
